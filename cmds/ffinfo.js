...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      ...
      const url = `https://fffinfo-api-by-sagor.vercel.app/api/ffinfo?uid=${uid}`;
...
⏳ 𝐀ᴄᴄᴏᴜɴᴛ 𝐂ʀᴇᴀᴛᴇ: ${b.createAt ? new Date(b.createAt * 1000).toLocaleDateString("en-GB") : "N/A"}
